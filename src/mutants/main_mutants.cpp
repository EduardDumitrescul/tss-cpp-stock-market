...
const std::string path = "../../src/portfolio/Portfolio.cpp"; // path to the file that will be mutated
const std::string backup_path = "../mutants/backup.txt"; // backup path of the original file
const int MODE = 1; // 1 = mutate, 0 = restore
